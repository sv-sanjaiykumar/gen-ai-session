...
def initialize_vector_db():
    ...
    if not os.path.exists(dataset_path):
        ...
        with open(dataset_path, "w", encoding="utf-8") as f:
            ...
            f.write("The first cat in space was a French cat named Felicette in 1963.\n")
...
if input_query:
    ...
    if not retrieved_knowledge:
        st.warning("No relevant context found. Check Ollama/model availability and try again.")
        st.stop()
